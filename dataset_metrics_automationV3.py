...
smoke_metrics_evaluator=metrics_evaluator(n,logs_path,results_path)
...
if only_evaluate==True or predict_then_evaluate==True:
    smoke_metrics_evaluator.run_kitti_AP_evaluation_executable(root_dir,precision_evaluation_path)
