...
from SMOKE.smoke.utils.comm import get_world_size
from SMOKE.smoke.utils.imports import import_file
from SMOKE.smoke.utils.envs import seed_all_rng
...
def build_dataset(cfg, transforms, dataset_catalog, is_train=True):
    ...
    for dataset_name in dataset_list:
        ...
        print("Dataset in Function: ",dataset)
...
def build_test_loader(cfg, is_train=False):
    ...
    DatasetCatalog = path_catalog.DatasetCatalog
    print("Data Set Catalog: ",DatasetCatalog)
