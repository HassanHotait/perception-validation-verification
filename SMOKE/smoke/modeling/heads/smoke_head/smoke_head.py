...
class SMOKEHead(nn.Module):
    ...
    def forward(self, features, targets=None,default=True,method="dataset_depth_refs",frame_id="All"):
        ...
        if not self.training:
            result = self.post_processor(x, targets,default,method,frame_id)
